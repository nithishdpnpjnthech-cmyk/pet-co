...
export default function DogTravelSupplies({ initialActive = 'All Travel Supplies' }) {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const categoryMap = {
          'dog-travel': 'Dog Travel Essentials',
          'dogtravel': 'Dog Travel Essentials',
          'travel': 'Dog Travel Essentials',
          'travel-supplies': 'Dog Travel Essentials'
        };

        const subcategoryMap = {
          'all-travel-supplies': 'All Travel Supplies',
          'all': 'All Travel Supplies',
          'carriers': 'Carriers',
          'carrier': 'Carriers',
          'travel-carriers': 'Carriers',
          'car-seat-covers': 'Car Seat Covers',
          'car-seats': 'Car Seat Covers',
          'seat-covers': 'Car Seat Covers',
          'travel-bowls': 'Travel Bowls',
          'travel-bowl': 'Travel Bowls',
          'portable-bowls': 'Travel Bowls',
          'first-aid': 'First Aid',
        ...
        let apiCategory = 'Dog Travel Essentials';
        ...
        const finalSubcategory = apiSubcategory || (active && active !== 'All Travel Supplies' ? active : null);

        console.log('DogTravelSupplies: Fetching all Dog products');
        ...
        console.log('DogTravelSupplies: Loaded', normalizedProducts.length, 'products');
        
      } catch (err) {
        console.error('Failed to load travel supplies products', err);
  ...
  useEffect(() => {
    ...
    const pageCategory = 'Travel Essentials'; // This page's category
    const urlParams = new URLSearchParams(location.search);
