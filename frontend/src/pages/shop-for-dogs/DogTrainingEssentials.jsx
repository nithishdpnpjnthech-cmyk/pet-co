...
export default function DogTrainingEssentials({ initialActive = 'All Training Essentials' }) {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const categoryMap = {
          'dog-training': 'Dog Training Essentials',
          'dogtraining': 'Dog Training Essentials',
          'training': 'Dog Training Essentials',
          'training-essentials': 'Dog Training Essentials'
        };

        const subcategoryMap = {
          'all-training-essentials': 'All Training Essentials',
          'all': 'All Training Essentials',
          'clickers': 'Clickers',
          'clicker': 'Clickers',
          'training-treats': 'Training Treats',
          'treats': 'Training Treats',
          'pads-diapers': 'Pads & Diapers',
          'pads': 'Pads & Diapers',
          'diapers': 'Pads & Diapers',
          'potty-training': 'Pads & Diapers'
        };
        ...
        let apiCategory = 'Dog Training Essentials';
        ...
        const finalSubcategory = apiSubcategory || (active && active !== 'All Training Essentials' ? active : null);

        console.log('DogTrainingEssentials: Fetching all Dog products');
        ...
        console.log('DogTrainingEssentials: Loaded', normalizedProducts.length, 'products');
        
      } catch (err) {
        console.error('Failed to load training essentials products', err);
  ...
  useEffect(() => {
    ...
    const pageCategory = 'Dog Training Essentials'; // This page's category
    const urlParams = new URLSearchParams(location.search);
  ...
  // horizontal scroll helpers for the top pill row
  const scrollTopLeft = () => {
    try {
      if (!topRef.current) return;
